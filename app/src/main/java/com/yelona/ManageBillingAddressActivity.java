...
public class ManageBillingAddressActivity extends AppCompatActivity {
    ...
    private String TAG = ManageBillingAddressActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_billing_information);
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            holder.btnDeliverHere.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    sessionManager.setBillingAddress(userDetails.get(SessionManager.KEY_USER_FIRSTNAME), userDetails.get(SessionManager.KEY_USER_EMAIL), userDetails.get(SessionManager.KEY_USER_MOBILE), ad.getAddress1() + ad.getAddress2() + ad.getCity() + ad.getPincode() + ad.getState(), ad.getId());
