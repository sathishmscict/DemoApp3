...
public class LevelBeamView extends View {
    ...
    private int getColorResIdForLevel(int level){
        switch(level){
            ...
            case 0: return R.color.level_default;
            case 1: return R.color.level_default;
            case 2: return R.color.level_default;
            case 3: return R.color.level_default;
            case 4: return R.color.level_default;
            case 5: return R.color.level_default;
            default: return R.color.level_default;
        }
    }
}
