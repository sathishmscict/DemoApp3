...
public class NewProductsDashBoardRecyclerViewAdapter extends RecyclerView.Adapter<NewProductsDashBoardRecyclerViewAdapter.MyViewHolder> {
    ...
    private String TAG = NewProductsDashBoardRecyclerViewAdapter.class.getSimpleName();

    public NewProductsDashBoardRecyclerViewAdapter(Context context, ArrayList<ProductData> listNewProduct, ArrayList<String> list_wishList) {
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView txtPrice, txtName, txtWishList, txtProductMRP;
    ...
    @Override
    public NewProductsDashBoardRecyclerViewAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View v = inflater.inflate(R.layout.row_single_product_dashboard, parent, false);
        MyViewHolder viewFolder = new MyViewHolder(v);
        return viewFolder;
    }

    @Override
    public void onBindViewHolder(final NewProductsDashBoardRecyclerViewAdapter.MyViewHolder holder, int position) {
        ...
        holder.txtWishList.setOnClickListener(new View.OnClickListener() {
            ...
            /*    dbhandler db = new dbhandler(_context);
                ...
                sendWishListDetailsToServer(db, sd, pd.getProductid(), pd.getPrice(), "add");
*/
        ...
        if (percentage == 0) {
            holder.txtWishList.setVisibility(View.GONE);
        } else {
            holder.txtWishList.startAnimation(AnimationUtils.loadAnimation(_context, R.anim.blinking_animation));

            if (percentage <= 9) {
                holder.txtWishList.setText(" " + percentage + " % OFF");
            } else {
                holder.txtWishList.setText("" + percentage + " % OFF");
            }
        ...
        //holder.txtPrice.setText(Html.fromHtml("<b>\u20b9" + pd.getPrice() + "</b>   " + " ₹<del>" + pd.getMrp() + "</del>"));
        ...
        holder.imgItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    sessionmanager.setActivityName("NewDashBoardActivity");
